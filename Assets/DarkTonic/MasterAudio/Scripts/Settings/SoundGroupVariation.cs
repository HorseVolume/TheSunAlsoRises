...
public class SoundGroupVariation : MonoBehaviour
{
	...
	public void FinishSetupToPlay() {
		...
		_audio.loop = this.audioLoops; // restore original loop setting in case it got lost by loop setting code below for a previous play.
