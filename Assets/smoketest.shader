...
/////// Diffuse:
                ...
                finalColor += diffuseLight * tex2D(_node2,TRANSFORM_TEX(node_11.rg, _node2)).rgb;
/// Final Color:
...
/////// Diffuse:
                ...
                finalColor += diffuseLight * tex2D(_node2,TRANSFORM_TEX(node_12.rg, _node2)).rgb;
/// Final Color:
